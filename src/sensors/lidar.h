...
struct Lidar
{
	...
	// the lidar constructor takes two arguments: list of cars and the slope of the ground
	...
	// this func generates PCL point cloud, which can be visualized by func renderRays in render.cpp. 
